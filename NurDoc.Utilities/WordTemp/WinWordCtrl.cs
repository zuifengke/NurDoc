    ...
    public partial class WinWordCtrl : Panel
    {
        ...
        private void HandleWordUILayout()
        {
            ...
            for (int index = 1; index <= nCount; index++)
            {
                ...
                {
                    this.m_WordApp.ActiveWindow.Application.CommandBars[index].Enabled = true;
                    this.m_WordApp.ActiveWindow.Application.CommandBars[index].Visible = true;
        ...
        {
            object asfilename = szFilePath;
            object missing = Type.Missing;
            //Word文档另存  szFilePath 文档路径

            this.m_WordDoc.SaveAs(ref asfilename, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing,
