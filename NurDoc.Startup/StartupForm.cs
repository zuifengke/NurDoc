...
namespace Heren.NurDoc.Startup
{
    public class StartupForm : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            string szCopyRight = string.Format("© 2011-{0} 浙江和仁科技有限公司版权所有，保留所有权利。", DateTime.Now.Year.ToString());
            rect.X = 8;
            ...
            string szSystemName = SystemContext.Instance.SystemName;
            Font font = new Font("楷体", 24.0f, FontStyle.Bold);
            rect.X = 8;
            rect.Y = this.Height - font.Height - 150;
            rect.Width = this.Width - (rect.X * 2);
            rect.Height = font.Height;
            stringFormat.Alignment = StringAlignment.Center;
            stringFormat.LineAlignment = StringAlignment.Center;
            e.Graphics.DrawString(szSystemName, font, brush, rect, stringFormat);
