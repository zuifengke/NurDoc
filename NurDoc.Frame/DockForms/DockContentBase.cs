...
namespace Heren.NurDoc.Frame.DockForms
{
    internal partial class DockContentBase : DockContent
    {
        ...
        /// </summary>
        [Browsable(false)]
        protected virtual MainFrame MainFrame
        {
            get
            {
        ...
        private bool m_bDataChanged = true;
        ...
        {
            get { return this.m_bDataChanged; }
        }
        ...
        public DockContentBase(MainFrame parent)
        {
        ...
        protected virtual void BindingSystemEvents()
        {
            ...
            this.m_mainFrame.ActiveContentChanged -= activeContentChangedEventHandler;
            this.m_mainFrame.ActiveContentChanged += activeContentChangedEventHandler;

            UserChangedEventHandler userChangedEventHandler =
                new UserChangedEventHandler(this.System_UserChanged);
            SystemContext.Instance.UserChanged -= userChangedEventHandler;
            SystemContext.Instance.UserChanged += userChangedEventHandler;

            EventHandler displayDeptChangedEventHandler =
                new EventHandler(this.System_DisplayDeptChanged);
            SystemContext.Instance.DisplayDeptChanged -= displayDeptChangedEventHandler;
            SystemContext.Instance.DisplayDeptChanged += displayDeptChangedEventHandler;

            EventHandler patientTableChangedEventHandler =
                new EventHandler(this.System_PatientTableChanged);
            PatientTable.Instance.PatientTableChanged -= patientTableChangedEventHandler;
            PatientTable.Instance.PatientTableChanged += patientTableChangedEventHandler;

            EventHandler dataChangedEventHandler = 
                new EventHandler(this.System_DataChanged);
            SystemContext.Instance.DataChanged -= dataChangedEventHandler;
            SystemContext.Instance.DataChanged += dataChangedEventHandler;
        }
        ...
        private void System_UserChanged(object sender, UserChangedEventArgs e)
        {
            this.m_bUserChanged = true;
            if (!this.DockHandler.IsHidden || this.m_bEventEnabledOnHidden)
                this.OnUserChanged(e);
        }
        ...
        private void System_DataChanged(object sender, EventArgs e)
        {
        ...
        protected override void OnFormClosed(FormClosedEventArgs e)
        {
            ...
            SystemContext.Instance.UserChanged -= new UserChangedEventHandler(this.System_UserChanged);
            SystemContext.Instance.DisplayDeptChanged -= new EventHandler(this.System_DisplayDeptChanged);
            SystemContext.Instance.DataChanged -= new EventHandler(this.System_DataChanged);
            this.m_mainFrame.ActiveContentChanged -= new EventHandler(this.MainFrame_ActiveContentChanged);
        }
    }
}
