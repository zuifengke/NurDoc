...
namespace Heren.NurDoc.Config.Report
{
    ...
    {
        private ReportTypeInfo m_reportTemplet = null;

        /// <summary>
        /// 获取当打开的是服务器文件时,
        /// 设计器窗口当前关联的服务器文件信息
        /// </summary>
        public ReportTypeInfo ReportTemplet
        {
        ...
        public bool Open(ReportTypeInfo reportTemplet)
        {
        ...
        /// <param name="szHndfFile">报表模板文件</param>
        /// <returns>是否成功</returns>
        public bool Open(ReportTypeInfo reportTemplet, string szHndfFile)
        {
            ...
            {
                string szDefaultHndfFile = string.Format("{0}\\Templets\\Default.hrdt"
        ...
        public void FindTextInAllTemplet(string szFindText, bool bMatchCase)
        {
            ...
            NurDoc.Data.TempletService.Instance.GetReportTemplet(ref lstReportTypeData);
